...
type GetQueryParams struct {
	...
	/* Q.
	   ...
	   Comma-delimited list of the Ids of the EventRelayConfigs for which to find the EventRelayFeedbacks
	*/
	Q string
...
// WithQ adds the q to the get query params
func (o *GetQueryParams) WithQ(q string) *GetQueryParams {
	o.SetQ(q)
	return o
}

// SetQ adds the q to the get query params
func (o *GetQueryParams) SetQ(q string) {
	o.Q = q
}
