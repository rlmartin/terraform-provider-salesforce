...
*/
func (a *Client) CreatePlatformEventChannelMember(params *CreatePlatformEventChannelMemberParams) (*CreatePlatformEventChannelMemberOK, error) {
	...
	return result.(*CreatePlatformEventChannelMemberOK), nil
