...
func SetPlatformEventChannelMemberUpdateRequestResourceData(d *schema.ResourceData, m *models.PlatformEventChannelMemberUpdateRequest, isDataResource bool) {
	if isDataResource {
		d.SetId("-")
	}
...
// Function to perform the following actions:
func PlatformEventChannelMemberUpdateRequestModelFromMap(m map[string]interface{}) *models.PlatformEventChannelMemberUpdateRequest {
...
func PlatformEventChannelMemberUpdateRequestModelFromArrayOfMap(m []interface{}) []*models.PlatformEventChannelMemberUpdateRequest {
	mapped := make([]*models.PlatformEventChannelMemberUpdateRequest, len(m))
	for i, v := range m {
		mapped[i] = PlatformEventChannelMemberUpdateRequestModelFromMap(v.(map[string]interface{}))
	}
	return mapped
}
